          ...
          return (
            <div
              ...
              className={`group relative transition-all duration-300 ease-out hover:z-10 ${
                !isEvenRow ? 'transform translate-x-3 md:translate-x-4 lg:translate-x-5' : ''
              }`}
              style={{
            ...
            >
              <Image
                ...
                width={100}
                height={100}
                className="object-contain transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 filter hover:brightness-110 select-none"
              />
